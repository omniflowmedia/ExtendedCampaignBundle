...
<div<?php echo ('interval' != $form['triggerMode']->vars['data']) ? ' class="hide"' : ''; ?> id="triggerInterval">
  <div class="mb-10">
    <?php echo $view['form']->row($form['triggerIntervalStatus']); ?>
  </div>
  <div class="row">
    <div class="<?php echo ('wait' == $form['triggerIntervalStatus']->vars['data']) ? 'col-sm-4' : 'col-sm-3'; ?>" id="triggerInterval-container">
      <?php echo $view['form']->row($form['triggerInterval']); ?>
    </div>
    
      <div class="col-sm-4 <?php echo ('wait' == $form['triggerIntervalStatus']->vars['data']) ? 'hide' : ''; ?>" id="triggerIntervalType-container">
        <?php echo $view['form']->row($form['triggerIntervalType']); ?>
      </div>
      <div class="col-sm-1 mb-0 mt-5 <?php echo ('wait' == $form['triggerIntervalStatus']->vars['data']) ? 'hide' : ''; ?>" id="label-container">
        <label>of</label>
      </div>

    <div class="<?php echo ('wait' == $form['triggerIntervalStatus']->vars['data']) ? 'col-sm-8' : 'col-sm-4'; ?>" id="triggerIntervalUnit-container">
