...
class CustomCampaignType extends CampaignType
{
    /**
     * @var CorePermissions
     */
    ...
    public function __construct(CorePermissions $security, TranslatorInterface $translator, Configuration $configuration)
    {
    ...
    public function buildForm(FormBuilderInterface $builder, array $options)
    {
        ...
        $type_options = $this->configuration->getTypeOptions();
        ...
        $builder->add(
            ...
            [
                ...
                'label'      => 'mautic.extendedcampaigns.type',
                'label_attr' => ['class' => 'control-label'],
                'attr'       => [
                    'class'   => 'form-control',
                    'length'  => 150,
                    'tooltip' => 'mautic.extendedcampaigns.help.type',
                ],
                'required' => true,
            ]
        );
