        ...
        if (in_array($options['data']['eventType'], ['action', 'condition'])) {
            ...
            $builder->add(
                ...
                [
                    ...
                    'required'          => false,
                    'attr'              => [
                        'onchange' => 'Mautic.customDaySelect();',
            ...
            $builder->add(
              ...
              $data = (!empty($options['data']['triggerIntervalType'])) ? $options['data']['triggerIntervalType'] : 'n';
              $builder->add(
                'triggerIntervalType',
                ChoiceType::class,
                [
                    'choices'     => [
                        'mautic.campaign.event.intervalunit.customchoice.n' => 'n',
